<?php include("includes/header.php"); ?>
      <input type="hidden" value="<?php echo $params?>" name="params" id="params">
        <div class="row plot-graph-widget">
            <div class="col-md-12">
		        <div class="row graph-body-box">
            <div class="col-md-12">
                <div class="row">
			    <div class="col-md-1">
                    <input class="fancy-radio-btn" type="radio" id="radio1" name="radios" value="all" >
		        ...
		        <div class="row">
                    <ul id="sales-carousel">
                        <li><input class="fancy-radio-btn" type="radio" id="r1" name="radios" value="all" >
                            <label  for="r1">Test</label></li>
                        <li><input class="fancy-radio-btn" type="radio" id="r2" name="radios" value="all" >
                            <label  for="r2">Test</label></li>
                        <li><input class="fancy-radio-btn" type="radio" id="r3" name="radios" value="all" >
                            <label  for="r3">Test</label></li>
                        <li><input class="fancy-radio-btn" type="radio" id="r4" name="radios" value="all" >
                            <label  for="r4">Test</label></li>
                    </ul>
